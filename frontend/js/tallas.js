document.addEventListener("DOMContentLoaded", () => {
        ...
        try{
            ...
            if(res.ok){
                ...
                Object.values(consulta).forEach(talla => {
                    ...
                    nuevaFila.innerHTML = `
                        <td class="prCol" data-id="${talla.id_talla}">
                            ${talla.descripcion}
                        </td>
                        <td>
    ...
    btnAgregarFila.addEventListener("click", () => {
        ...
        nuevaFila.innerHTML = `
            <td class="prCol">
                <input type="text" class="descripcion" placeholder="Ingrese descripcion de categoria">
            </td>
            <td>
    ...
    const eventosFila = fila => {
        ...
        btnModificar.addEventListener("click", () => {
            ...
            prCol.innerHTML = `<input type="text" value="${valor}" class="descripcion" placeholder="Ingrese descripcion de categoria">`
        ...
        btnRegistrar.addEventListener("click", async () => {
            ...
            if(descripcion == ""){
                alert("La descripcion de la nueva talla está vacia, rellénelo")
                return false;
            }
    ...
    document.querySelectorAll(".cont-tallas").forEach(fila => {
        eventosFila(fila);
    })
